// js/coaching/ip_pareado_ofensivo.js
...
const COACHING = {
  title: "Plan (IP PAREADO OFENSIVO)",
  ...
  reminders: [
    "PAREADO_OFENSIVO: board favorece al agresor → cbet chica con todo el rango.",
    "Si te raiséan fuerte: disciplina (MVP).",
  ],
};

export const coachingIPPareadoOfensivo = {
  id: "IP_PAREADO_OFENSIVO",

  match(rec) {
    return rec?.spot === "IP_OFENSIVO_PAREADO";
  },
